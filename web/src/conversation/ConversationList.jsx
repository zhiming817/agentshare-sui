...
export default function ConversationList() {
  ...
  const loadMyResumes = async () => {
    ...
    try {
      ...
      const data = await conversationService.getMyResumes(walletAddress);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const walletAddress = publicKey;
      await conversationService.deleteResume(id, walletAddress);
  ...
  const handlePriceSubmit = async () => {
    ...
    try {
      const walletAddress = publicKey;
      await conversationService.setResumePrice(priceResumeId, walletAddress, priceFloat);
  ...
  const handleRenameSubmit = async () => {
    ...
    try {
      const walletAddress = publicKey;
      await conversationService.updateResumeName(renameResumeId, walletAddress, renameValue);
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link to={`/conversation/edit/${resume.id}`}>
