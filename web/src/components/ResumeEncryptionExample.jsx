...
import { createEncryptedResume } from '../services/conversationEncryption';
import { unlockAndDecryptResume } from '../services/conversationEncryption';
...
完整数据已打印到控制台`);
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">会话加密上传示例</h1>
      ...
      <div className="mb-8 p-4 border rounded">
        <h2 className="text-xl font-semibold mb-4">1. 创建加密会话</h2>
        <button
      ...
      {/* 解密会话 */}
      <div className="mb-8 p-4 border rounded">
        <h2 className="text-xl font-semibold mb-4">2. 解密会话（测试）</h2>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-blue-900">
          <li>
            <strong>创建会话：</strong>前端使用 AES-256-GCM 加密 → 上传到 IPFS → 获取 CID → 传给后端
          </li>
          <li>
          ...
          <li>
            <strong>生产环境：</strong>购买会话需要先支付，后端验证后返回 CID，再进行解密
          </li>
        </ol>
      </div>
    </div>
